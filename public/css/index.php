    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <!-- First Blog Post -->
                <h2>
                        <a href="<?= 'http://' . $_SERVER['HTTP_HOST'] . '/post.php?id=' . $post['id'] ?>"><?= $post['post_title'] ?></a>
                ...
                <hr>
                    ...
                    <a href="<?= 'http://' . $_SERVER['HTTP_HOST'] . '/post.php?id=' . $post['id'] ?>">
                        <img class="img-responsive" src="<?= file_exists(__DIR__ . '/images/' . $post['post_image']) ? '/images/' . $post['post_image'] : $post['post_image'] ?>">
